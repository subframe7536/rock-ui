...
export default function CommandPaletteDemos() {
  ...
  return (
    <DemoPage componentKey="command-palette">
      ...
      <DemoSection
        title="Basic"
        description="Groups of items with icons, kbds, and descriptions."
        demo={Basic}
      />
      ...
      <DemoSection
        ...
        demo={WithCloseButton}
      />

      <DemoSection
        title="Loading"
        description="Search icon becomes a spinner while loading."
        demo={Loading}
      />
